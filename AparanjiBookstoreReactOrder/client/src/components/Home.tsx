        ...
        <div className="home-page">
            ...
            <section className="top-genres">
                ...
                <div className="cta-box">
                    <Link className="genre-box horror" to="/categories/Horror" onClick={() => navigate("/categories:Horror")}>
                        <div className="genre-text">Horror</div>
                    </Link>
                    <Link className="cta-button" to="/categories/Best Sellers">Shop More <FontAwesomeIcon icon={faGreaterThan} /><FontAwesomeIcon icon={faGreaterThan} /></Link>
                </div>
            </section>
        </div>
    )
