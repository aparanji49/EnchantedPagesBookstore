...
function CheckoutPage()
{
    ...
    */
    ...
    const cartTotalPrice = asDollarsAndCents(totalBookCart(cart)+5); // code that calculates the total price of your cart
...
// let creditCardRegex = new RegExp(/^(?:\d[ -]*?){13,16}$/);
    ...
    {
        // code that returns true is the customer form is valid, false otherwise
        let isValid = true;
    ...
    // placeOrder function comes here. Needed for project 9 (not 8)
    ...
    // submitOrder function comes here. See the project Spec
            ...
            <div className="checkout-page-body">
                ...
                <div>
                    ...
                    >
                        ...
                        {/*  form elements for phone, address, email, and Credit card*/}
                        ...
                        <div className="input-pairs">
                            ...
                            {/* the select input for the expiration year. Read the spec */}
                            {/* about this*/}
                ...
                {/* the checkout box with the total cost, tax */}
