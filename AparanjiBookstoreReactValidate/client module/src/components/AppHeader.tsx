    ...
    <header className="container">
        ...
        <section className="menu-items">
            ...
            <section className="cart-section">
                <Link id="cart-icon" to="/cart"><img className="cart" src={require('../assets/images/site/Cart.png')} alt="cart"/></Link>
                <Link id="cart-icon" to="/cart"> <div className="cart-count">{cartQuantity}</div></Link>
            </section>
            <section>
